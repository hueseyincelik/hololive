...
class Microscope:
	...
	def __del__(self):
		if self.camera is not None:
			self.microscope.set_camera_param(self.camera, {'exposure(s)': 4.0, 'binning': 1})
	...
	def get_image_size(self):
		...
		return self.camera_properties['height'] // self.binning, self.camera_properties['width'] // self.binning
