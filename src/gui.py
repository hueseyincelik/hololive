...
class GUI:
	...
	def reconstruct(self):
		...
		img_cut_out = img_fft_shifted[cut_out_idx[0][0]:cut_out_idx[0][1], cut_out_idx[1][0]:cut_out_idx[1][1]]
		...
		self.object_image_wave = sfft.ifft2(np.pad(img_cut_out, ((padding, padding), (padding, padding)), constant_values=0))
